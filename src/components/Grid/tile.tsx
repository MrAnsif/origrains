...
export const GridTileImage: React.FC<Props> = ({
  ...
  return (
    <div
      className={clsx(
        'group flex h-full w-full items-center justify-center overflow-hidden rounded-lg border bg-white hover:border-card dark:bg-black',
        {
          'border-2 border-card': active,
